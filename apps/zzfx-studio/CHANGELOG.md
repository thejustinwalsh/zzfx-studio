...
- d9d9ceb: > Branch: claude/tracker-note-entry-def3a5
  ...
  The ignore pattern is \*_/ prefixed deliberately: a pattern containing a
  slash anchors to the .gitignore's own directory, so the existing bare
  public/workbox-v_ form matches only a repo-root public/ and never
